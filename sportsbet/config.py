...
MEMBER_CONSENSUS_BLEND_ML = float(os.getenv("MEMBER_CONSENSUS_BLEND_ML", "0.22"))
MEMBER_CONSENSUS_BLEND_SPREAD = float(os.getenv("MEMBER_CONSENSUS_BLEND_SPREAD", "0.25"))
MEMBER_CONSENSUS_BLEND_TOTAL = float(os.getenv("MEMBER_CONSENSUS_BLEND_TOTAL", "0.22"))
